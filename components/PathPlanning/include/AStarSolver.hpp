...
struct AStarConfig {
  HeuristicType heuristicType =
      HeuristicType::Euclidean;  ///< Heuristic function selection
};
...
class AStarSolver : public IPathPlanner {
 public:
   ...
   */
  esp_err_t findPath(int32_t startNode, int32_t targetNode,
                     Path& outPath) override;
 ...
 private:
   ...
   */
  int32_t findInSearchList(const std::vector<int32_t>& list,
